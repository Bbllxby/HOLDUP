...
function library:Window(options)
    local TitleUI = options.Title or "Bbllxby Lib"
    local Accent = options.Accent or Color3.fromRGB(255, 255, 255)
    local Logo = options.Logo or '17074287212'
    ...
    function TabsFunc:NewTab(options)
        local Logo = options.Logo or '17060611888'
        ...
        function mid_sections:TabSection(options)
            ...
            Toggle_Section.ImageColor3 = Color3.fromRGB(240, 255, 255)
            ...
            Section_Header.MouseButton1Click:Connect(function()
                if tab_toggled == false then 
                    ...
                    TweenService:Create(Toggle_Section, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {ImageColor3 = Color3.fromRGB(240,255,255)}):Play()
                    TweenService:Create(Section_Header, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {TextColor3 = Color3.fromRGB(240, 255, 255)}):Play()
            ...
            function columns:AddColumn(options)
                ...
                function frame_sections:Section(options)
                    ...
                    NewSecName.TextColor3 = Color3.fromRGB(255, 255, 255)
                    ...
                    function main_functions:Button(options)
                        ...
                        uiButton.BackgroundColor3 = Color3.fromRGB(240, 255, 255)
                    ...
                    function main_functions:Textbox(options)
                        ...
                        text_shell.BackgroundColor3 = Color3.fromRGB(240, 255, 255)
                    ...
                    function main_functions:Dropdown(options)
                        ...
                        function dropdown_functions:UpdateList(List)
                            ...
                            for i,v in pairs(List) do
                                ...
                                option.Name = "option"
                                option.Parent = Dropdown_Container
                                option.BackgroundColor3 = Color3.fromRGB(240, 255, 255)
                                option.BorderSizePixel = 0
                                option.Size = UDim2.new(0, 258, 0, 20)
                                option.AutoButtonColor = false
                                option.Font = Enum.Font.Gotham
                    ...
                    function main_functions:Slider(options)
                        ...
                        slider_holder.BackgroundColor3 = Color3.fromRGB(240, 255, 255)
                        ...
                        slider_shell.BackgroundColor3 = Color3.fromRGB(240, 255, 255)
